...
add_dialog("Along the way you may find new friends but remember 1 will always get you back to green.", true, spr_avatar_green, false);
add_dialog("Now paint the world friend!", false, spr_avatar_green, false);

d_red_text = 
add_dialog("I am red", true, spr_avatar_red, true);
add_dialog("End", false, spr_avatar_red, true);

d_blue_text = 
add_dialog("I am blue", true, spr_avatar_red, true);
add_dialog("End", false, spr_avatar_blue, true);

d_hole_text = 
add_dialog("Oops, looks like you fell down a hole there friend.");
